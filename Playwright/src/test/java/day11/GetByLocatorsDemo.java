...
//		page.getByText("Login").click(); Same text is not allowed here.
		page.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions()
				.setName("Login")).last().click();
		/*
		page.getByPlaceholder("Search books or authors").fill("The Hookup");
...
//		Placeholder works with contains method
		page.getByRole(AriaRole.OPTION).first().click();
		page.getByAltText("Book cover image").click();
		System.out.println(page.url());
